...
export function Carousel() {
  ...
  return (
    <div className="w-full bg-white mt-[100px] hidden md:flex md:flex-col">
      {/* {carousel.map((post) => ( */}
      {carousel.length > 0 && (
        <Link href={`/blog/${carousel[page].id}`}>
          <div
            key={carousel.id}
          ...
          >
            ...
            <div
              ...
              className="bg-white rounded-[12px]  gap-6"
            >
              <div className="flex w-1/2 flex-col  bg-white p-[40px] gap-4 rounded-[12px] absolute left-[11px] bottom-[13px] ">
