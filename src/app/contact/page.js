...
export default function Contact() {
  return (
    <div className="flex flex-col bg-white md:max-w-[769px] w-full mx-auto mt-[100px] gap-5">
      <div className="flex flex-col px-[10px] md:max-w-[769px] w-full m-auto text-justify pt-[14px] gap-5">
      ...
      <div className="max-w-[643px] rounded-[10px] bg-[#F6F6F7] pt-[29px] pr-[130px] pb-[26px] pl-[35px] mb-[166px]">
        <form className="flex flex-col gap-6 ">
          ...
          />
          <button className="bg-[#4B6BFB] font-medium w-fit rounded-md py-[10px] px-[16px] text-sm text-white">
            Send Message
          </button>
        </form>
      </div>
